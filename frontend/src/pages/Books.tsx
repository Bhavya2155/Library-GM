    ...
    <div className="h-full overflow-y-auto p-8">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-4">
          ...
          <button onClick={() => { setEditingId(null); setForm({ title: '', author: '', isbn: '', category: '', quantity: 1 }); setShowModal(true); }} className="bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 text-white px-5 py-2 rounded-xl font-medium flex items-center gap-2 shadow-md shadow-indigo-200 transition-all hover:-translate-y-0.5">
          ...
          <table className="w-full text-left border-collapse table-fixed">
            <thead>
              <tr className="bg-white/40 text-slate-600 text-xs uppercase tracking-wider border-b border-white/50 backdrop-blur-md">
                ...
                <th className="p-4 font-semibold w-[35%]">Title</th>
                <th className="p-4 font-semibold w-[20%]">Author</th>
                <th className="p-4 font-semibold w-[15%]">Category</th>
                <th className="p-4 font-semibold w-[10%]">Availability</th>
                <th className="p-4 font-semibold w-[10%]">Actions</th>
              </tr>
            </thead>
